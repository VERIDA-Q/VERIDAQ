...
import { useBatches } from "@/lib/portal/queries";
import { formatDate, batchStatusLabel } from "@/lib/portal/utils";
import type { CredentialBatch } from "@/lib/portal/api";
    ...
    <TableRow>
      ...
      <TableCell>
        <Button variant="ghost" size="sm" asChild>
          <Link href={`/portal/batches/${batch.id}`}>
    ...
    <div className="p-6 md:p-8 max-w-7xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button asChild>
            <Link href="/portal/upload">Upload Credentials</Link>
          </Button>
        </div>
      </div>
                  ...
                  <TableCell colSpan={6} className="text-center py-16">
                    <div className="flex flex-col items-center gap-2 text-muted-foreground">
                      ...
                      <Button asChild className="mt-2">
                        <Link href="/portal/upload">Upload your first batch</Link>
                      </Button>
                    </div>
                  </TableCell>
                </TableRow>
