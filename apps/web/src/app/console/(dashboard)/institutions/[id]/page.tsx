...
import {
  ...
  DialogTitle,
  DialogFooter,
} from "@/components/console/ui/dialog";
import { Label } from "@/components/console/ui/label";
import { Input } from "@/components/console/ui/input";
import { useInstitution, useApproveInstitution, useSuspendInstitution, useRejectInstitution } from "@/lib/console/queries";
import { kycStatusLabel, formatDate } from "@/lib/console/utils";
