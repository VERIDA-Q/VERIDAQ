...
import {
  ...
  TableHeader,
  TableRow,
} from "@/components/console/ui/table";
import { useEmployers } from "@/lib/console/queries";
import { kycStatusLabel, formatDateShort } from "@/lib/console/utils";
                ...
                {employers.map((emp) => {
                  ...
                  return (
                    <TableRow key={emp.id} className="hover:bg-muted/30">
                      ...
                      <TableCell>
                        <Link href={`/console/employers/${emp.id}`} className="flex items-center gap-1 text-xs text-navy hover:underline whitespace-nowrap">
