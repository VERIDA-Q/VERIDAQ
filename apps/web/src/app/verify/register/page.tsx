      ...
      <div className="min-h-screen flex items-center justify-center bg-white px-4">
        <div className="bg-white rounded-2xl border border-[#520061]/10 p-10 max-w-md w-full flex flex-col items-center gap-4 text-center">
          ...
          <Button variant="outline" asChild className="mt-2">
            <Link href="/verify/login">Back to Sign In</Link>
          </Button>
        </div>
      </div>
    );
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    />
                    {errors.cacNumber && <p className="text-xs text-red-500">{errors.cacNumber.message}</p>}
                  </div>
                  <div className="space-y-1.5">
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    />
                    {errors.contactNin && <p className="text-xs text-red-500">{errors.contactNin.message}</p>}
                  </div>
                </div>
                <div className="space-y-1.5">
