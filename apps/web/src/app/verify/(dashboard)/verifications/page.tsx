...
import { Card, CardContent } from "@/components/verify/ui/card";
import { Badge } from "@/components/verify/ui/badge";
import { Skeleton } from "@/components/verify/ui/skeleton";
import {
  Select,
  SelectContent,
  SelectItem,
  SelectTrigger,
  SelectValue,
} from "@/components/verify/ui/select";
import {
  Table,
  TableBody,
  TableCell,
  ...
  TableHeader,
  TableRow,
} from "@/components/verify/ui/table";
import { useVerifications } from "@/lib/verify/queries";
import { verificationStatusLabel, formatDate } from "@/lib/verify/utils";
                ...
                {filtered.map((v) => {
                  ...
                  return (
                    <TableRow key={v.id} className="hover:bg-muted/30">
                      ...
                      <TableCell>
                        <Link
                          href={`/verify/verifications/${v.id}`}
