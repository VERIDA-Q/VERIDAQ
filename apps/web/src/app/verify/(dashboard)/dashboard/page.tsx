...
import { Card, CardContent, CardHeader, CardTitle } from "@/components/verify/ui/card";
...
import { useProfile, useVerifications } from "@/lib/verify/queries";
import { useVerifyStore } from "@/store/verify";
import { formatDate, verificationStatusLabel } from "@/lib/verify/utils";
    ...
    <div className="p-6 md:p-8 max-w-6xl mx-auto space-y-8">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Link href="/verify/verify" className="group">
